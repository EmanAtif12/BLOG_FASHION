      ...
      <div class="services_section_2">
         <div class="row">
            ...
            <div class="col-md-4">
               ...
               <div class="btn_main active"><a href="{{ url('/services/personal-shopping') }}">Personal Shopping</a>
               </div>
            </div>
            <div class="col-md-4">
               <div><img
                     src="https://images.pexels.com/photos/4621910/pexels-photo-4621910.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                     class="services_img" alt="Custom Tailoring" style="height: 235px; object-fit: cover;"></div>
